...
@synthesize delegate, tableView,logoView;
...
- (void)addSubviewsToHeaderView:(UIView *)headerView
{
  ...
  CGRect previousMonthButtonFrame = CGRectMake(self.left+200,
  ...
  CGRect monthLabelFrame = CGRectMake((self.width/2.0f) - (kMonthLabelWidth/2.0f)-50,
                                      kHeaderVerticalAdjust,
                                      kMonthLabelWidth,
                                      kMonthLabelHeight);
...
- (void)setHeaderTitleText:(NSString *)text
{
  ...
  headerTitleLabel.left = floorf(self.width/2.f - headerTitleLabel.width/2.f-50);
}
